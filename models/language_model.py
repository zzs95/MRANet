...
class LanguageModel(nn.Module):
    ...
    def forward(self,
        ...
        inputs_embeds = self.wte(input_ids)  # shape [batch_size x seq_len x hidden_dim] [batch_size, 1] [batch_size, 1, 1024]
        ...
        position_embeds = self.wpe(position_ids)  # shape [1 x seq_len x hidden_dim]
